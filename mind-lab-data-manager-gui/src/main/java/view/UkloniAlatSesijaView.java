...
public class UkloniAlatSesijaView {
    public void show(int idSesije) {
        ...
        btnUkloniAlat.setOnAction(actionEvent -> {
            ...
            String sql = "{CALL ukloni_alat_iz_sesije(?, ?, ?)}";
            ...
            try (Connection conn = Config.getConnection();
                ...
                Alert alert = new Alert("Uspesno uklonjen alat".equals(poruka)
                ...
                if ("Uspesno uklonjen alat".equals(poruka)) {
                    ((Stage) btnUkloniAlat.getScene().getWindow()).close();
                }
            } catch (Exception ex) {
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setHeaderText("Greska pri uklanjanju alata");
        ...
        VBox vbox = new VBox();
        vbox.getChildren().addAll(alatLabel, alatComboBox, btnUkloniAlat);
        vbox.setSpacing(10);
